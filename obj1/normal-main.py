...
from pyMetaheuristic.test_function import  bohachevsky_1, eggholder, holder_table, mccormick
...
target_value = target_value_eggholder
target_position = target_position_eggholder
